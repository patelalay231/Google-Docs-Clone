...
const DocumentList = () => {
  ...
  const fetchDocuments = async () => {
    try {
      const response = await axios.get(`https://google-docs-clone-ssiw.onrender.com/api/document/get-documents`, {
        headers: {
  ...
  const handleCreateNewDocument = async () => {
    try {
      const response = await axios.post(`https://google-docs-clone-ssiw.onrender.com/api/document/create-document`, null, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
        },
      });
  ...
  const handleStarDocument = async (documentId) => {
    try {
      const response = await axios.post(`https://google-docs-clone-ssiw.onrender.com/api/document/star-document/${documentId}`, null, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
        },
      });
  ...
  const handleDeleteDocument = async (documentId) => {
    try {
      await axios.delete(`https://google-docs-clone-ssiw.onrender.com/api/document/delete-document/${documentId}`, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
        },
      });
